...
<body onload="updateClock(); setInterval('updateClock()', 1000 )" style="background:url(u.jpg) no-repeat center center fixed; background-size:cover; 
...
<center> 
    <table style="border:0; " align="center" width="95%" height="99%" cellpadding="4"  border="0">
     <tr>
         <td  NOWRAP valign="top" align="center" width="16%">
             <table border="0"><tr><td colspan="3">
                <span style="font-size:8pt;">invite friends to join</span>
             </td>
             </tr><tr>
               <td align="center"><img  title="Get your stream going before you invite - click the big video or the ... menu at top right." src="fb.png" style="width:25px;" /></td>
               <td align="center"><img  title="Get your stream going before you invite - click the big video or the ... menu at top right." src="inst.png" style="width:25px;" /></td>
               <td align="center"><img  title="Get your stream going before you invite - click the big video or the ... menu at top right." src="tw.png" style="width:25px;" /></td>
             </tr></table><br />
<a href="#" title="Switch to this.">
<video  style="vertical-align:super; margin:0; padding:0; border:0; width:93%; " valign="top" id="localVideox" autoplay muted >
</video></a>             

<br /><span style="font-size:7pt;">(nobody has joined yet)</span><br />
             <img src="static.gif" width="95%"/><br />&nbsp;<br /><img src="static.gif" width="95%"/>
             <br />&nbsp;<br /><span style="font-size:7pt;">Stream to<br /><img  title="Sign up before you can stream - click the big video or the ... menu at top right." src="fb.png" width="50"/><br />(not connected)
<br />&nbsp;<br />&nbsp;<br />
<a target="_blank" style="color:lightblue;" href="http://theget.io/wordpress">blog</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a  target="_blank"  style="color:lightblue;" href="http://speedtest.net">speedtest</a>&nbsp;&nbsp;|&nbsp;<a  target="_blank"  style="color:lightblue;" href="http://theget.io/wordpress/index.php/support">support</a>
&nbsp;&nbsp;|&nbsp;<a  target="_blank"  style="color:lightblue;" href="http://theget.io/wordpress/index.php/pricing">prices</a>
<br />&nbsp;<br />
...
Tweet, text, email or otherwise notify your friends (with or without cams) to join you at: <?php print $_SESSION["subd"] ?>.TheGet.io</span>
   ...
   <td valign="top"  align="center"  width="16%">
        <table border="0"><tr><td colspan="3">
               ...
               <td align="center"><img  title="Get your stream going before you invite - click the big video or the ... menu at top right." src="dg.png" style="width:25px;" /></td>
               <td align="center"><img  title="Get your stream going before you invite - click the big video or the ... menu at top right." src="rdt.png" style="width:25px;" /></td>
               <td align="center"><img  title="Get your stream going before you invite - click the big video or the ... menu at top right." src="su.png" style="width:25px;" /></td>
             </tr></table><br />
       <img src="static.gif" width="95%"/><br />&nbsp;<br /><img src="static.gif" width="95%"/><br />&nbsp;<br /><img src="static.gif" width="95%"/><br />&nbsp;<br /><span style="font-size:8pt;">Stream to<br /><img title="Sign up before you can stream - click the big video or the ... menu at top right." src="yt.png" width="50"/><br />(not connected)</span>
<br />&nbsp;<br />&nbsp;<br />
<span id="clock" style="color:white;font-size:9pt;"><b>&nbsp;</b></span>
<br />&nbsp;<br />
<span style="color:lightblue; font-size:7pt;">
Viewers: 0 | Cams: 0 | FB: 0 | YT: 0
<br />&nbsp;<br />
Chryon: <input  class="pop" type=text size="9" DISABLED placeholder="name, title" />&nbsp;&nbsp;&nbsp;&nbsp;in&nbsp;&nbsp;&nbsp;&nbsp;out
<br />&nbsp;<br />
Other Targets: Twitch, BTR, etc.
</span></td>
</tr>
</table></center>
...
<table class="pop" cellpadding="10" cellspacing="15" width="100%" style="-moz-border-radius:8px; -webkit-border-radius:8px; border-radius:8px; 
 border:2px solid lightgray; ">
<tr><td NOWRAP style="color:navy;" >                
<b>Pick&nbsp;a&nbsp;short&nbsp;name&nbsp;for&nbsp;your&nbsp;channel:</b><br />
<input  class="pop" type=text length="6" id ="handle" name="handle" placeholder="myChannel" /><img style="width:40px; float:right;" src="arrow.dr.png" /><br />
direct your friends (with or without cams) to<br /><font color=red><i><span id="txtout"></span></i>.TheGet.io</font>
<span style="font-size:9pt;">(make it short for tweeting)</span>
</td>
<td style="color:navy;background:lightgreen;" colspan="2">
<table  cellpadding="8" border="0" >
<td valign="top" style="border:0;color:navy;" rowspan="3"><b>...OR...<br />I&nbsp;set&nbsp;up&nbsp;beforehand</b><br />just log me in<br /></td>
<tr><td style="border:0;color:navy;" align="right"><span style="float:right;text-align:right; font-size:8pt;">Channel name or email: </span></td><td><input  class="pop" type=text length="6" placeholder="email/channel" />
</td></tr>
<tr><td style="border:0; color:navy; text-align:right;" align="right"><span style="float:right;text-align:right; font-size:8pt;">Password: </span></td><td><input type=text class="pop"  length="6" placeholder="***" />
</td></tr></table>
</td>
</tr>
<td  valign="top" width="15%" style="color:navy;"><b><input type=radio>Solo Director/Solo Control Room</b><br />
...
but your curious friends cannot check out your guest streams for themselves.  This is a great choice if you really want viewers to focus entirely on your message. Best, for classes, seminars, conferences, etc.<br />$5.99 - 65 minutes</td>
<td  width="15%" style="color:navy;"><b><input CHECKED type=radio>'Everyone' is a Director/Shared Ctrl Room</b><br />
<font style="font-size:10pt;">Everyone gets their own 'control room' like you see here and can pick what 
...
goes to Facebook, Youtube, other destinations (no struggle there!). Better for entertainment or party style programming, or hangout type events.<br />$9.99 - 65 minutes</td>
...
...so you can get going <i><u>fast</u></i> at show time.  You can also view all pricing plans at this link.</p>   
</td>
</tr></table>  
</div>
...
<p><b>Connect to the project from Eclipse on Ubuntu 16.04 LTS</b><br />
...
You will get a 'Permission Denied' error if you try to overwrite a file (and having the backup is nice, too).<br />
If something like index.x.php already exists, then delete it before all of the above.  This kluge is because of a documented RSE bug.</p>
