			...
			<tr>
				<td valign="top" align="center" width="16%">
					...
					style="font-size: 8pt;">Stream to<br /> <img
						...
						href="http://theget.io/io">blog</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a
...
.pop input {
	...
	<div id="pmenu"
		...
		<p>
			...
			&nbsp;&nbsp;|&nbsp;&nbsp;<a target="_blank"
				href="https://github.com/thegetvip">TheGetvip GitHub Repo</a>
		</p>

		<p>
			<b>Connect to the project from Ubuntu 16.04 LTS</b><br /> 1. Download
			Eclipse Neon (latest version) from Eclipse.org<br /> 2. Untar
			anywhere and run eclipse-install<br /> 3. Select the PHP developer's
			version and install<br /> 4. Navigate to the install folder you
			specified and run Eclipse; pin to launcher<br /> 5. Eclipse PHP
			already has Mylin and Git so go to Help | Eclipse Marketplace and get
			Toad for mySQL<br /> 6. Using Window | Perspective | Open Perspective
			| Other | Git, issue a pull request to
			github.com/thegetvip/thegetvip.github.io<br /> 7. Email Ron
			ron@theget.io for db login credentials<br />
