...
Tweet, text, email or otherwise notify your friends (with or without cams) to join you at: <?php print $_SESSION["subd"] ?>.TheGet.io</span>
   ...
   <td valign="top"  align="center"  width="16%">
       ...
       <img src="tv.jpg" width="95%"/><br />&nbsp;<br /><img src="tv.jpg" width="95%"/><br />&nbsp;<br /><img src="tv.jpg" width="95%"/><br />&nbsp;<br /><span style="font-size:8pt;">Stream to<br /><img title="Sign up before you can stream - click the big video or the ... menu at top right." src="yt.png" width="50"/><br />(not connected)</span>
<br />&nbsp;<br />&nbsp;<br />
<span id="clock" style="color:white;font-size:11pt;"><b>&nbsp;</b></span>
<br />&nbsp;<br />
<span style="color:lightblue; font-size:7pt;">
Viewers: 0 | Cams: 0 | FB: 0 | YT: 0
<br />&nbsp;<br />
Chryon: <input  class="pop" type=text size="9" placeholder="name, title" />&nbsp;&nbsp;&nbsp;&nbsp;in&nbsp;&nbsp;&nbsp;&nbsp;out
<br />&nbsp;<br />
...
<div id="pmenu" style="width:75%;font-size:9pt;font-color:navy;overflow:auto; height:450;" title="Dev Menu for Innoc.us">
    ...
    <p><a id="ll" target="_blank" style="color:navy;" href="http://theget.io/wordpress">blog</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a  target="_blank"  style="color:navy;" href="http://speedtest.net">speedtest</a>
...
<p><b>Connect to the project from Ubuntu 16.04 LTS</b><br />
